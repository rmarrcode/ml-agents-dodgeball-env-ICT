...
public class DistanceToolEditor : Editor
{
	...
	public override void OnInspectorGUI(){		
		...
		_target.startObject = EditorGUILayout.ObjectField(_target.startObject, typeof(Object), true);
		_target.endObject = EditorGUILayout.ObjectField(_target.endObject, typeof(Object), true);
